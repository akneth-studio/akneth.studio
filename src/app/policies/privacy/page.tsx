    ...
    return (
        <>
            <article>
                ...
                <p>Administrator w celu prowadzenia serwisu korzysta z usług zewnętrznego dostawcy hostingu, VPS lub Serwerów Dedykowanych - <strong><a rel="nofollow external" href="https://render.com/privacy">Render, Inc.</a></strong>. Wszelkie dane gromadzone i przetwarzane w serwisie są przechowywane i przetwarzane w infrastrukturze usługodawcy zlokalizowanej poza obrębem granic Unii Europejskiej. Istnieje możliwość dostępu do danych wskutek prac serwisowych realizowanych przez personel usługodawcy. Dostęp do tych danych reguluje umowa zawarta pomiędzy Administratorem a Usługodawcą.</p><br />
                <p><strong>Przekazanie danych osobowych - Usługi Księgowe</strong></p>
                <p>W przypadku zawarcia transakcji, część danych osobowych osób fizycznych lub dane osób fizycznych prowadzących działalność gospodarczą, jest przekazywana podmiotowi świadczącemu na rzecz Administratora usługi księgowe <a rel="nofollow external" href="https://fakturownia.pl/polityka-prywatnosci">Fakturownia sp. z o.o.</a>. Przekazanie tych danych reguluje Ustawa .... oraz umowa zawarta pomiędzy Administratorem a Usługodawcą.</p><br />
